    ...
    <SafeAreaView style={styles.screen}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.adminFormRow}>
          <TouchableOpacity style={styles.formButton} onPress={() => navigation.navigate('EmployeeForm')}>
            <Text style={styles.formButtonText}>Add Employee Form</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.formButton} onPress={() => navigation.navigate('AssetForm')}>
            <Text style={styles.formButtonText}>Add Asset Form</Text>
          </TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
  ...
  searchBox: { flex: 1, marginHorizontal: 2, padding: 6, borderRadius: 8, borderWidth: 1, borderColor: '#ccc', backgroundColor: '#fff', color: '#000' },
  adminFormRow: { flexDirection: 'row', justifyContent: 'space-around', marginTop: 15, marginBottom: 10 },
  formButton: { backgroundColor: '#03a9f4', paddingVertical: 10, paddingHorizontal: 15, borderRadius: 8 },
